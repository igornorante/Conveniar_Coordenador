...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> mGetContent = registerForActivityResult(
            ...
            uri -> {
                if (uri != null) {
                    // Salva a URI para persistência
                    getSharedPreferences("USUARIO", MODE_PRIVATE)
                            .edit()
                            .putString("FOTO_PERFIL", uri.toString())
                            .apply();
                    
                    // Atualiza a imagem na tela atual
                    if (imgPerfil != null) {
    ...
    protected void setupDrawer() {
        ...
        if (navigationView != null) {
            ...
            // Carrega Foto Salva
            String fotoSalva = getSharedPreferences("USUARIO", MODE_PRIVATE).getString("FOTO_PERFIL", null);
            if (fotoSalva != null && imgPerfil != null) {
